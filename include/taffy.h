...
#define TAFFY_HASH(str) (Taffy::fnv1a_hash(str))
        ...
        enum class FeatureFlags : uint64_t {
            ...
            PBRMaterials = 1ULL << 7,
            Animation = 1ULL << 8,
            EditorModified = 1ULL << 9,  // Asset was modified in editor and contains custom vertices
            Physics = 1ULL << 10,
            Audio = 1ULL << 11,
            Scripting = 1ULL << 12,
            MultiLOD = 1ULL << 13,
            VirtualTextures = 1ULL << 14,
            SVGUI = 1ULL << 15,
            OverlaySupport = 1ULL << 16,
            SDFFont = 1ULL << 17,         // Signed Distance Field fonts
            AIBehavior = 1ULL << 32,
